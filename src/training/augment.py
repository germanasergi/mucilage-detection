...
# Input
patches = np.load("/home/ubuntu/mucilage_pipeline/mucilage-detection/saved_npy/train_cache_sst_cmems.npz")["X"]
...
np.savez_compressed("/home/ubuntu/mucilage_pipeline/mucilage-detection/saved_npy/train_cache_sst_cmems_augmented.npz", X=X_aug)
